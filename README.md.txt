...
![Azure Stream Analytics Job Diagram](./images/stream-analytics-job-diagram.png)
...
![Real-Time FinTech Sentiment Dashboard](./images/dashboard.jpg)
...
![Python Producer Running](./images/python-producer-running.png)
...
![Azure Stream Analytics Pipeline Monitoring](./images/azure-pipeline-monitoring-overview.png)
...
*(You need to take a screenshot of your Azure SQL Query Editor running `SELECT TOP 10 * FROM SentimentData ORDER BY EventTimestamp DESC;` and save it as `images/sql-query-results.png`)*
![Data in Azure SQL Database](./images/sql-query-results.png)
...
![ASA Activity Log - Table Not Found Error](./images/azure-activity-log-failure.png)
...
![ASA Activity Log - Successful Operations After Fix](./images/azure-activity-log-success.png)
